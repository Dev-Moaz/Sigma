// ── app/(auth)/create_account/page.tsx
"use client";
...
function NoiseGrain({ opacity = 0.025 }: { opacity?: number }) {
  return (
    ...
    >
      ...
      >
        <filter id="vt-noise-grain-clean-register">
          <feTurbulence
            type="fractalNoise"
            baseFrequency="0.8"
            numOctaves="3"
        ...
        <rect width="100%" height="100%" filter="url(#vt-noise-grain-clean-register)" />
      </svg>
    </div>
  );
}
...
// ==========================================
function SubmitButton({ className = "", step, onClick }: { className?: string, step: RegisterStep, onClick: () => void }) {
        ...
        >
          ...
          <div className="mb-8 text-center">
            ...
            <p className="text-sm font-medium" style={{ color: t.textSecondary }}>
              Join Sigma to build your ultimate setup
            </p>
          </div>
          ...
          <form className="flex flex-col gap-4" onSubmit={(e) => { e.preventDefault(); handleRegister(); }}>
            ...
            <div className="flex flex-col gap-1.5">
              <label
                ...
                style={{ color: nameFocused ? t.accentText : t.textSubtle }}
              >
                Full Name
              </label>
              <div className="relative flex items-center">
                <FontAwesomeIcon
                  ...
                  style={{ color: nameFocused ? t.accentText : t.textMuted }}
                />
                <input
                  type="text"
                  ...
                  style={{
                    ...
                    border: `1px solid ${nameFocused ? t.accentText : t.borderSubtle}`,
                    boxShadow: nameFocused ? `0 0 0 3px ${t.glowCyan}20` : "none",
                  }}
                />
              </div>
            </div>
            ...
            <div className="mt-4 flex justify-center">
              <SubmitButton step={registerStep} onClick={handleRegister} />
            </div>
          </form>
          ...
          {/* Sign In Link */}
          <p className="text-center text-[13px] font-medium mt-7" style={{ color: t.textSecondary }}>
            Already have an account?{" "}
            <Link href="/login" className="font-bold ml-1 transition-colors hover:underline" style={{ color: t.accentText }}>
              Sign In
            </Link>
          </p>
